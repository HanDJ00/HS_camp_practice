package com.ohgiraffers.chap12_generic.level1_normal;
...
public class Application2 {
    ...
    //    Application1 클래스 내에 static 메소드로 작성하며 배열을 매개변수로 받아
//    해당 요소들의 합계를 반환하도록 한다. Number 하위 타입이 아닌 경우 컴파일 에러가 발생하는 것을 확인한다.
