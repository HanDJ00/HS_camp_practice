package com.ohgiraffers.chap05_array.demension1_array.level1_basic;
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        int search_fruit = scanner.nextInt();

        if (search_fruit >= 0 && search_fruit <= 4) {
            System.out.println(fruits[search_fruit]);
