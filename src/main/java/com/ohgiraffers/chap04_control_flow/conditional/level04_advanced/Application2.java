package com.ohgiraffers.chap04_control_flow.conditional.level04_advanced;
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        if (sales > 50000000){
            bonus = 5;
            bonus_money = sales * 5 / 100;
        }else if (sales > 30000000){
            bonus = 3;
            bonus_money = sales * 3 / 100;
        }else if (sales > 10000000){
            bonus = 1;
            bonus_money = sales * 1 / 100;
        }
        ...
        System.out.println("보너스 금액 : " + bonus_money);
        System.out.println("======================");
        System.out.println("총 급여 : " + (salary + bonus_money));
